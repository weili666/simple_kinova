...
*/
XsSnapshot* XsDataPacket_fullSnapshot(XsDataPacket const * thisPtr, XsSnapshot* returnVal)
{
...
*/
int XsDataPacket_containsFullSnapshot(XsDataPacket const * thisPtr)
{
...
/*! \relates XsDataPacket
	...
	\returns The supplied \a returnVal, filled with the requested data or cleared if it was not available
*/
XsSnapshot* XsDataPacket_awindaSnapshot(XsDataPacket const * thisPtr, XsSnapshot* returnVal)
{
...
/*! \relates XsDataPacket
	...
	\returns The supplied \a returnVal, filled with the requested data or cleared if it was not available
*/
XsByteArray* XsDataPacket_rawBlob(XsDataPacket const * thisPtr, XsByteArray* returnVal)
{
...
*/
int XsDataPacket_containsRawBlob(XsDataPacket const * thisPtr)
{
...
/*! \relates XsDataPacket
	...
	\param data The new data to set
*/
void XsDataPacket_setRawBlob(XsDataPacket* thisPtr, XsByteArray const * data)
{
